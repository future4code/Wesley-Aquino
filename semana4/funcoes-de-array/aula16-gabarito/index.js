...
function imprimirDespesas(despesas){
    ...
    despesas.forEach((despesa, index, arrDespesas) => {
        ...
        let divDespesas1 = document.getElementById('despesas')
        divDespesas1.innerHTML +=`<p><u>Tipo de gasto: ${despesa.tipo} | Descrição: ${despesa.descricao} | Valor: ${despesa.valor}</u></p>`     
 })
